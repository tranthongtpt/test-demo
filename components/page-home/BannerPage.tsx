          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="text-center lg:text-left ">
              <div className="mb-10 lg:mb-0 ">
                <h1 className="leadingng-tight mb-3 mt-0 text-3xl font-bold text-white sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight ">
                  Chinh phục IELTS cùng Dream bằng việc bắt tay thi thử
                  <span className="relative whitespace-nowrap">
                    ...
                    <span className="relative uppercase"> miễn phí </span>
                  </span>
                  ngay thôi!
                </h1>
