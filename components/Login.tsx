    ...
    <div>
      ...
      <div className="flex items-center justify-center w-full min-h-full my-56 text-gray-600">
        <div className="relative">
          <div className="absolute hidden w-56 h-56 text-red-300 a-z-10 -left-20 -top-20 sm:block">
          ...
          <div className="absolute hidden text-red-300 a-z-10 -bottom-20 -right-20 h-28 w-28 sm:block">
            <svg id="patternId" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern
                  id="b"
            ...
            <div className="flex-auto p-6">
              ...
              <form onSubmit={onSubmit} className="mb-4">
                <div className="mb-4">
                  <label
                    htmlFor="email"
                    className="inline-block mb-2 text-xs font-medium text-gray-700 uppercase"
                  >
                    Tên đăng nhập
                  </label>
                  <input
                    type="text"
                    className="block w-full px-3 py-2 text-sm border border-gray-400 rounded-md outline-none appearance-none bg--100 cursor-text focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow"
                    id="email"
                    name="email-username"
                ...
                <div className="mb-4">
                  <div className="flex justify-between">
                    ...
                    <Link
                      href="#"
                      className="text-red-500 no-underline cursor-pointer hover:text-red-400"
                    >
                  ...
                  <div className="relative flex flex-wrap items-stretch w-full">
                    <input
                      type="password"
                      id="password"
                      className="relative flex-auto block px-3 py-2 text-sm border border-gray-400 rounded-md outline-none appearance-none bg--100 cursor-text focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow"
                      name="password"
                      placeholder="············"
                      value={password}
                      onChange={(e) => {
