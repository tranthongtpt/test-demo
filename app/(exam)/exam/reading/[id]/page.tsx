...
import Screen from '@/components/dashboard/student/Reading/Screen'
  ...
  return (
    <>
      <div className="flex h-screen flex-col">
            ...
            <div className='flex flex-wrap items-center justify-center w-full space-x-4 '>
              ...
              <div className="flex flex-col flex-wrap">
                <div className="flex w-full flex-wrap items-center justify-center space-x-4 ">
                  ...
                  <span className="font-semibold text-red-600">Reading </span>
        ...
        <Footer onOpen={onOpen} link={'/exam/writing/1'} />
      </div>
