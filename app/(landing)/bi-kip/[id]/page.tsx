...
const getClassName = (level: number | null): string | undefined => {
  switch (level) {
    case 2:
      return 'head2'
    case 3:
...
const DetailBlog: React.FC<{ params: { id: string } }> = ({ params }) => {
  ...
  useEffect(() => {
    const elements: Heading[] = Array.from(document.querySelectorAll('h3, h4')).map((elem) => ({
      id: elem.id,
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span
                      className="ml-1 text-sm font-medium text-gray-300 md:ml-2"
                      aria-current="page"
                    >
                      {params.id}
                    </span>
        ...
        <div className="flex flex-wrap justify-between">
          <div className="mb-8 w-full px-4 md:w-8/12">
            <div className="">
              ...
              <p>{DummyText}</p>
              <p>{DummyText}</p>
              <h3 id='sixth-header className="text-xl"'>
                Linking heading to there respective sections
              </h3>
              <p>{DummyText}</p>
              <p>{DummyText}</p>
            ...
            <div className="pt-2">
              <div className="items-center justify-between md:flex">
                <div className="mb-4 flex items-center space-x-2 font-medium md:mb-0">
                  <span>0 Bình luận</span>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="inline-flex overflow-hidden rounded transition-all duration-200 hover:text-blue-900">
                    <button
                      aria-label="facebook"
              ...
              <div className="mt-2 flex items-center justify-center">
                <div className="h-80 w-full rounded-[12px] border bg-white p-4 px-7 shadow-md">
                  <p className="cursor-pointer text-xl font-semibold text-blue-900 transition-all hover:text-black">
                    Add Comment
                  </p>
                  <textarea
                    className="mt-5 h-40 w-full resize-none rounded-lg border border-gray-300 px-3 py-1 text-sm outline-none placeholder:text-sm"
                    placeholder="Add your comments here"
                  ></textarea>

                  <div className="mt-2 flex justify-between">
                    <p className="text-sm text-blue-900 ">Enter atleast 15 characters</p>
                    <button className="h-12 w-[150px] cursor-pointer rounded-lg bg-red-400 text-sm text-white transition-all hover:bg-red-600">
                      Bình luận
                    </button>
                  </div>
                </div>
          ...
          <div className="mb-8 w-full px-4 md:w-4/12">
            <aside className=" top-28 h-fit lg:sticky">
              <div className="-left-56 top-20 mb-10 w-full rounded-md border bg-white px-6 py-6 shadow-md ">
                <div className="pb-2 text-xl font-medium text-red-600">Nội dung chính</div>
                <hr className="h-1 w-10 bg-red-600" />
                <nav>
                  <ul>
